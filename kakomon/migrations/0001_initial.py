# Generated by Django 4.2.7 on 2024-07-14 16:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('navigation_or_engineering', models.CharField(choices=[('navigation', '航海'), ('engineering', '機関')], max_length=11, verbose_name='航海・機関')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('navigation', '航海'), ('operation', '運用'), ('law', '法規'), ('english', '英語'), ('engineering1', '機関1'), ('engineering2', '機関2'), ('engineering3', '機関3'), ('working', '執務一般')], max_length=12, verbose_name='科目')),
